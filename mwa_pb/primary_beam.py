...
def MWA_Tile_full_EE(za, az, freq,
    ...
    # If we could import hyperbeam, then use it to calculate the Jones matrices.
    if "mwa_hyperbeam" in sys.modules:
        ...
        if interp:
            # hyperbeam should be fast enough that this isn't important.
            logger.warning('interpolation is not performed when using hyperbeam')
