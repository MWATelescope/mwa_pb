...
def make_beam(filename, ext=0, delays=None,
              ...
              precess=True,
              interp=True,
              dipheight=pb.DIPOLE_HEIGHT,
              dip_sep=pb.DIPOLE_SEPARATION):
  """
  ...
  if model == 'analytic':
    ...
    f[ext].header.set('BEAMMODL', 'SH_V' + str(pb.h5fileversion), 'Primary beam model')
  elif model == '2014':
