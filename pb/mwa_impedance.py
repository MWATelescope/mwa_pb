...
class LNAImpedance(object):
  ...
  def __init__(self):
    ...
    self.Z = numpy.array([52.803 + 151.76j, 52.446 + 154.04j, 52.19 + 157.03j, 51.811 + 160.69j,
                          ...
                          14.683 - 78.282j, 14.643 - 78.058j, 14.614 - 77.894j, 14.594 - 77.713j], dtype=numpy.complex)
...
class TileImpedanceMatrix(object):
  ...
  def getImpedanceMatrix(self, freq):
    ...
    if numpy.abs(self.freqs[pos] - freq) > 5e6:
      logger.warning("Nearest tabulated impedance matrix freq is more than 5 MHz away from desired freq of " + str(
        freq / 1e6) + " MHz")
...
if __name__ == "__main__":
  ...
  za = "14"
  delays = numpy.array([6, 6, 6, 6, 4, 4, 4, 4, 2, 2, 2, 2, 0, 0, 0, 0, 6, 6, 6, 6, 4, 4, 4, 4, 2, 2, 2, 2, 0, 0, 0, 0])
  ...
  for i in range(len(freqs)):
    ...
    plt.imshow(numpy.abs(z_total), interpolation='nearest', cmap=plt.cm.gist_stern)
